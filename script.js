...
const weatherDescription = weather_data.weather[0].description.toLowerCase();
   ...
   if (weatherDescription.includes('scattered clouds')) {
    weather_img.src = "https://png.pngtree.com/png-clipart/20230929/original/pngtree-sunny-bright-weather-png-image_13016266.png"; // scattered clouds image
} else if (weatherDescription.includes('overcast clouds')) {
    weather_img.src = "https://png.pngtree.com/png-vector/20220621/ourmid/pngtree-daytime-foggy-weather-clouds-illustration-png-image_5246770.png"; // overcast image
